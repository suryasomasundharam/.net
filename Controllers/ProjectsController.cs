...
namespace newproject2.Controllers
{
    public class ProjectsController : Controller
    {
        ...
        public ProjectsController(EmployeeDetailsDBContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Project != null ? 
                          ...
                          Problem("Entity set 'EmployeeDetailsDBContext.Project'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'EmployeeDetailsDBContext.Project'  is null.");
            }
            var project = await _context.Project.FindAsync(id);
            if (project != null)
            {
